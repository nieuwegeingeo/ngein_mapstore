...
module.exports = require('./MapStore2/build/buildConfig')(
    {
        'ngein': path.join(__dirname, "js", "app"),
        'ngein-embedded': path.join(__dirname, "js", "embedded"),
        'ngein-api': path.join(__dirname, "MapStore2", "web", "client", "product", "api"),
